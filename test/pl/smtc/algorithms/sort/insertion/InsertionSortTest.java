...
class InsertionSortTest extends BaseTestOut {
    ...
    @Test
    void executeShouldInvokeInsertionSortExample() {
    ...
    @Test
    void getNameShouldReturnInsertionSortString() {
    ...
    void sortShouldCorrectlySortInputTable(List<Integer> toSort, List<Integer> sorted) {
        assertEquals(sorted, insertionSort.sort(toSort));
    }
