...
class InterpolationSearchTest extends BaseTestOut {
    ...
    @Test
    void executeShouldInvokeInterpolationSearchExample() {
        interpolationSearch.execute();
    ...
    @Test
    void getNameShouldReturnInterpolationSearchString() {
        assertEquals("Interpolation search", interpolationSearch.getName());
    }
    ...
    void findShouldThrowExceptionWhenNoElementIsFound() {
        ...
        assertThrows(NoSuchElementException.class, () -> interpolationSearch.find(testList, nonExistingElement));
    }
    ...
    void findShouldCorrectlySearchExistingInputElement(List<Integer> toFind, int item, int result) {
        assertEquals(result, interpolationSearch.find(toFind, item));
    }
