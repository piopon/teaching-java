...
class BinarySearchTest extends BaseTestOut {
    ...
    @Test
    void executeShouldInvokeBinarySearchExample() {
    ...
    @Test
    void getNameShouldReturnBinarySearchString() {
    ...
    void findShouldThrowExceptionWhenNoElementIsFound() {
        ...
        assertThrows(NoSuchElementException.class, () -> binarySearch.find(testList, nonExistingElement));
    }
    ...
    void findShouldCorrectlySearchExistingInputElement(List<Integer> toFind, int item, int result) {
        assertEquals(result, binarySearch.find(toFind, item));
    }
