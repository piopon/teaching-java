...
import pl.smtc.patterns.creational.factory.AbstractFactory.product.lamp.CeilingLamp;
...
import pl.smtc.patterns.creational.factory.AbstractFactory.product.lamp.WallLamp;
import pl.smtc.patterns.creational.factory.AbstractFactory.product.mount.DowelsMounting;
...
import pl.smtc.patterns.creational.factory.AbstractFactory.product.mount.ScrewsMounting;
import pl.smtc.patterns.creational.factory.AbstractFactory.product.source.ESource;
import pl.smtc.patterns.creational.factory.AbstractFactory.product.source.LedSource;
import pl.smtc.patterns.creational.factory.AbstractFactory.product.source.NeonSource;
...
class OutdoorLampFactoryTest {
    ...
    @Test
    void getNameShouldReturnOutdoorLampString() {
    ...
    void createLampShouldReturnRegisteredLampType() {
        ...
        assertTrue(result.getDescription().contains("[IP67]"));
    }
    ...
    void createMountingShouldReturnRegisteredMountType() {
        ...
        assertTrue(result.getDescription().contains("8 SCREWS"));
    }
    ...
    void createSourceShouldReturnRegisteredSourceType() {
        ...
        assertTrue(result.getDescription().contains("TRANSPARENT glass"));
    }
