...
public class IndoorLampFactory extends LampFactory {
    private final static int MOUNTING_ELEMENTS_NO = 4;
    ...
    public Lamp createLamp(ELamp lamp) throws NullPointerException {
        ...
        created.setCaseProtection("IP20");
